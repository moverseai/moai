...
class AttentionSkip(torch.nn.Module):
    def __init__(self,
        ...
        self.skip = mic.make_conv_block(block_type='conv2d',
        ...
        self.gate = mic.make_conv_block(block_type='conv2d',
        ...
        self.attention = mic.make_conv_block(block_type='conv2d',
        ...
        self.proj = mic.make_conv_block(block_type='conv2d',
        ...
        self.upsample = Interpolate(scale=2.0,
            mode=upsample.mode,
